      ...
      <table class="table">
        ...
        <tbody>
          <tr v-for="rout in routs" v-bind:key="rout.id">
            ...
            <td><button class="btn btn-warning" v-on:click="deleteRouteClicked(rout.id)">Delete</button></td>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <select v-model="selected_point">
              <option disabled value="">Выберите точку поставки</option>
          ...
          <div class="form-group">
              <select v-model="selected_agent">
                <option disabled value="">Выберите агента</option>
